...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_Ordbase_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__load_selectClient_js__ = __webpack_require__(3);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('keydown', e => {
        if (e.keyCode === KEY_HOME) Object(__WEBPACK_IMPORTED_MODULE_1__load_selectClient_js__["a" /* load_selectClient */])();
    });

    Object(__WEBPACK_IMPORTED_MODULE_1__load_selectClient_js__["a" /* load_selectClient */])();
});
...
/* harmony export (immutable) */ __webpack_exports__["f"] = container_setClientContainerArray;
/* harmony export (immutable) */ __webpack_exports__["g"] = language_get;
/* unused harmony export languages_create */
/* harmony export (immutable) */ __webpack_exports__["h"] = language_getClientLanguageArray;
/* harmony export (immutable) */ __webpack_exports__["i"] = language_setClientLanguageArray;
...
function container_setClientContainerArray({ clientKey = Object(__WEBPACK_IMPORTED_MODULE_0__Util_js__["a" /* force */])('clientKey'),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_Util_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_select_client_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_card_client_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_header_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__load_editClient_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__load_newClient_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__load_selectTranslation_js__ = __webpack_require__(22);
...
function load_selectClient() {
    ...
    // -1. Set up Ordbase
    //
    __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["a" /* OnLanguageChange */](() => {
        load_selectClient();
    });
    __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["b" /* async_loadContainer */]('Ordbase', 'SelectClient');

    //
    // 0. Create component instances
    //
    const header = new __WEBPACK_IMPORTED_MODULE_6__components_header_js__["a" /* Component_Header */]();
    const view = new __WEBPACK_IMPORTED_MODULE_4__views_select_client_js__["a" /* View_SelectClient */]();
    ...
    async_client_getArray({
        success: clientArray => {
            clientArray.forEach(client => {
                ...
                let card = new __WEBPACK_IMPORTED_MODULE_5__components_card_client_js__["a" /* Component_ClientCard */]();
                ...
                card.setEventHandlers({
                    onselect: (card, e) => {
                        Object(__WEBPACK_IMPORTED_MODULE_9__load_selectTranslation_js__["a" /* load_selectTranslation */])(card.getKey());
                    },
                    onedit: (card, e) => {
                        Object(__WEBPACK_IMPORTED_MODULE_7__load_editClient_js__["a" /* load_editClient */])(card.getKey());
                    }
                });
    ...
    // 3. Set up header
    //
    __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('selectClient', text => {
        header.setTheme({ textSmall: 'Ordbase', textBig: text, selectable: true });
    });
    ...
    header.setEventHandlers({
        ...
        button1_onclick: event => {
            ...
            if (!cardArray[0].isEditable()) {
                ...
                __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('editClient', text => header.setTheme({ textBig: text, editable: true }));
                ...
                header.setEventHandlers({
                    ...
                    button2_onclick: e => {
                        ...
                        __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('selectClient', text => header.setTheme({ textBig: text, selectable: true }));
                        header.setIcons({ button1: __WEBPACK_IMPORTED_MODULE_0__App_js__["ICON_PENCIL"], button2: __WEBPACK_IMPORTED_MODULE_0__App_js__["ICON_PLUS"] });
                        header.setEventHandlers({ button2_onclick: e => {
                                Object(__WEBPACK_IMPORTED_MODULE_8__load_newClient_js__["a" /* load_newClient */])();
                            } });
                        view.focus();
                    }
                });
...
//  @note todo
//
function async_client_getArray({ success = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('success') }) {
    ...
    if (!preload_clientArrayPromise) {
        __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["b" /* client_get */]().then(clientArray => {
            if (clientArray.length > 0) success(clientArray);else __WEBPACK_IMPORTED_MODULE_0__App_js__["flashError"](__WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('errorNoClients'));
        ...
        preload_clientArrayPromise.then(clientArray => {
            if (clientArray.length > 0) {
                ...
                __WEBPACK_IMPORTED_MODULE_0__App_js__["flashError"](__WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('errorNoClients'));
            }
        });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__header_html__ = __webpack_require__(15);
...
class Component_Header extends HTMLElement {
    ...
    constructor() {
        ...
        root.innerHTML = __WEBPACK_IMPORTED_MODULE_0__header_html___default.a;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = async_loadContainer;
/* harmony export (immutable) */ __webpack_exports__["a"] = OnLanguageChange;
/* harmony export (immutable) */ __webpack_exports__["c"] = translate;
/* unused harmony export translate2 */
...
function OnLanguageChange(handler) {
    ...
    if (languageChangeObserver) languageChangeObserver.disconnect();
    // create an observer instance
    languageChangeObserver = new MutationObserver(function (mutations) {
        let mutation = mutations.find(mutation => {
...
function translate(translationKey, success) {
    console.log('lang: ', html.getAttribute('lang'));
    containerPromise.then(keyvalueArray => {
        let text = keyvalueArray.find(keyvalue => {
            return keyvalue.key == translationKey;
        }).value;
        success(text);
    }).catch(error => {
        let text = 'not found';
...
//
function translate2(translationKey1, translationKey2, success) {

    containerPromise.then(keyvalueArray => {
        let text1 = keyvalueArray.find(keyvalue => {
            return keyvalue.key == translationKey1;
        }).value;
        let text2 = keyvalueArray.find(keyvalue => {
            return keyvalue.key == translationKey2;
        }).value;
        success(text1, text2);
    }).catch(error => {
        let text = 'not found';
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__edit_client_html__ = __webpack_require__(17);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__generator_container_html__ = __webpack_require__(18);
...
class Component_ContainerGenerator extends HTMLElement {
    ...
    constructor() {
        super();
        let root = this.createShadowRoot();
        root.innerHTML = __WEBPACK_IMPORTED_MODULE_0__generator_container_html___default.a;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__flipper_language_html__ = __webpack_require__(19);
...
class Component_LanguageFlipper extends HTMLElement {
    ...
    constructor() {
        super();
        let root = this.createShadowRoot();
        root.innerHTML = __WEBPACK_IMPORTED_MODULE_0__flipper_language_html___default.a;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__form_client_html__ = __webpack_require__(20);
...
class Component_ClientCard extends HTMLElement {
    ...
    constructor() {
        super();
        let root = this.createShadowRoot();
        root.innerHTML = __WEBPACK_IMPORTED_MODULE_0__card_client_html___default.a;
        this._getElementById = root.getElementById.bind(root);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_edit_client_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_header_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_generator_container_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_flipper_language_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_form_client_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__load_selectClient_js__ = __webpack_require__(3);
...
//  @note @todo
//
function async_container_getClientContainerKeyArray_container_getNonEmptyArray({ clientKey = Object(__WEBPACK_IMPORTED_MODULE_2__lib_Util_js__["a" /* force */])('clientKey'),
    ...
    __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["d" /* container_getClientContainerArray */]({ clientKey: clientKey }).then(clientContainerArray => {
        containerKeyArray = clientContainerArray.map(clientContainer => {
            return clientContainer.containerKey;
        });
        return __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["e" /* container_getNonEmpty */]({ clientKey: clientKey });
...
//  @note @todo
//
function async_language_getArray_client_getClientLanguageKeyArray({ success = Object(__WEBPACK_IMPORTED_MODULE_2__lib_Util_js__["a" /* force */])('success'),
    clientKey = Object(__WEBPACK_IMPORTED_MODULE_2__lib_Util_js__["a" /* force */])('clientKey') }) {

    let languageArray = null;
    __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["g" /* language_get */]().then(_languageArray => {
        languageArray = _languageArray;
        return __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["h" /* language_getClientLanguageArray */]({ clientKey: clientKey });
    }).then(clientLanguageArray => {
        success(languageArray, clientLanguageArray.map(clientLanguage => {
...
function async_clientGet({ success = Object(__WEBPACK_IMPORTED_MODULE_2__lib_Util_js__["a" /* force */])('success'),
    ...
    __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["b" /* client_get */]({ clientKey: clientKey }).then(clientArray => {
...
function async_client_update({ success = Object(__WEBPACK_IMPORTED_MODULE_2__lib_Util_js__["a" /* force */])('success'),
    ...
    containerKeyArray = Object(__WEBPACK_IMPORTED_MODULE_2__lib_Util_js__["a" /* force */])('containerKeyArray'),
    languageKeyArray = Object(__WEBPACK_IMPORTED_MODULE_2__lib_Util_js__["a" /* force */])('languageKeyArray')
}) {

    __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["c" /* client_update */]({ clientKey: client.key, client: client }).then(res => {
        console.log('client_update():', res.status);
        if (res.status == __WEBPACK_IMPORTED_MODULE_0__App_js__["HTTP_UPDATED"]) {

            __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["f" /* container_setClientContainerArray */]({
                clientKey: client.key,
                clientContainerArray: containerKeyArray.map(containerKey => {
                    return { containerKey: containerKey, clientKey: client.key };
                })
            }).then(res => {
...
//  @note @todo
//
function async_language_getArray({ success = Object(__WEBPACK_IMPORTED_MODULE_2__lib_Util_js__["a" /* force */])('success') }) {

    __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["g" /* language_get */]().then(languageArray => {
...
function async_client_create({ success = Object(__WEBPACK_IMPORTED_MODULE_2__lib_Util_js__["a" /* force */])('success'),
    ...
    __WEBPACK_IMPORTED_MODULE_1__lib_Ordbase_js__["a" /* client_create */]({ client: client }).then(res => {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_Util_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__views_select_translation_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_header_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_card_translation_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_generator_translation_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_picker_container_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__load_selectClient_js__ = __webpack_require__(3);
...
function load_selectTranslation(clientKey) {
    ...
    //
    __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["a" /* OnLanguageChange */](() => {
        load_selectTranslation(clientKey);
    });
    __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["b" /* async_loadContainer */]('Ordbase', 'SelectTranslation');

    //
    // 0. Init components
    //
    const view = new __WEBPACK_IMPORTED_MODULE_4__views_select_translation_js__["a" /* View_SelectTranslation */]();
    const header = new __WEBPACK_IMPORTED_MODULE_5__components_header_js__["a" /* Component_Header */]();
    const generator = new __WEBPACK_IMPORTED_MODULE_7__components_generator_translation_js__["a" /* Component_TranslationGenerator */]();
    const picker = new __WEBPACK_IMPORTED_MODULE_8__components_picker_container_js__["a" /* Component_ContainerPicker */]();
    const cardPrototype = new __WEBPACK_IMPORTED_MODULE_6__components_card_translation_js__["a" /* Component_TranslationCard */]();
            ...
            containerKeyArray.forEach(containerKey => {
                ...
                picker.makeItem({
                    ...
                    onclick: e => {
                        ...
                        //
                        __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('selectTranslation', text => header.setTheme({ textBig: text, selectable: true }));
                        ...
                        header.setEventHandlers({ button2_onclick: e => {
                                Object(__WEBPACK_IMPORTED_MODULE_9__load_selectClient_js__["a" /* load_selectClient */])();
                            } });
                    }
                });
            });
    ...
    cardPrototype.setEventHandlers({
        onopen: (card, e) => {
            ...
            __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('editTranslation', text => header.setTheme({ textBig: text, editable: true }));
    ...
    __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('selectTranslation', text => header.setTheme({ textSmall: 'Ordbase', textBig: text, selectable: true }));
    header.setIcons({ button1: __WEBPACK_IMPORTED_MODULE_0__App_js__["ICON_TRASH"], button2: __WEBPACK_IMPORTED_MODULE_0__App_js__["ICON_ARROW_LEFT"] });
    header.setEventHandlers({
        ...
        button1_onclick: e => {
            ...
            if (cardArray.length > 0) {
                if (!cardArray[0].isDeleteable()) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('deleteTranslation', text => header.setTheme({ textBig: text, deleteable: true }));
                    header.setIcons({ button1: __WEBPACK_IMPORTED_MODULE_0__App_js__["ICON_NONE"], button2: __WEBPACK_IMPORTED_MODULE_0__App_js__["ICON_TIMES"] });
                    header.setEventHandlers({
                        button2_onclick: e => {
                ...
                __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('errorNothingToDelete', text => __WEBPACK_IMPORTED_MODULE_0__App_js__["flashError"](text));
                picker.focus();
            }
        },
        // 2.2 Back to select client view
        button2_onclick: e => Object(__WEBPACK_IMPORTED_MODULE_9__load_selectClient_js__["a" /* load_selectClient */])()
    });
...
//
function makeTranslationCard({ cardPrototype = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('cardPrototype'),
    groupMeta = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('groupMeta'),
    languageKeyArray = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('languageKeyArray') }) {
    ...
    let card = new __WEBPACK_IMPORTED_MODULE_6__components_card_translation_js__["a" /* Component_TranslationCard */]();

    card.setTranslationKey(groupMeta.key);
    __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('updateTranslation', text => card.setSubmitButtontext(text));
    __WEBPACK_IMPORTED_MODULE_2__lib_Ordbase_translate_plugin_js__["c" /* translate */]('checkboxText', text => card.setCheckboxText(text));
...
//
function async_translation_getGroup({ success = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('success'),
...
//
function async_translation_getGroupMetaArray({ success = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('success'),
    clientKey = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('clientKey'),
    containerKey = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('containerKey') }) {
...
//
function async_translation_getGroupMeta({ success = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('success'),
    clientKey = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('clientKey'),
    containerKey = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('containerKey'),
    translationKey = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('translationKey') }) {
...
// @function async_translation_delete
//
function async_translation_delete({ success = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('success'),
    clientKey = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('clientKey'),
    containerKey = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('containerKey'),
    translationKey = Object(__WEBPACK_IMPORTED_MODULE_3__lib_Util_js__["a" /* force */])('translationKey') }) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__select_translation_html__ = __webpack_require__(24);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__card_translation_html__ = __webpack_require__(26);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__generator_translation_html__ = __webpack_require__(28);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__picker_container_html__ = __webpack_require__(30);
